...
const ProfessionalTaxParameters = () => {
  ...
  const handleUpdateParameters = async (e) => {
    ...
    if (id !== "") {
      ...
      await UpdateApi("professionaltaxparameters", data, id)
        .then((res) => {
          if (res) {
            setLoading(false);
      ...
      await CreateApi("professionaltaxparameters", data1)
        .then((res) => {
          if (res) {
            setLoading(false);
            setShowApiSuccessAlert(true);
    ...
    <>
      <div className="page-wrapper">
        <div className="content container-fluid">
          {/* Page Header */}
          <Breadcrumbs
            maintitle="Professional Tax Parameters"
            title="Dashboard"
            subtitle="Professional tax Parameters"
          />
          {/* /Page Header */}
          <div className="row">
...
export default ProfessionalTaxParameters;
