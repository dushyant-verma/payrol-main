...
import Branch from "../../views/pages/Employees/Branch.jsx";
import Category from "../../views/pages/Employees/Category.jsx";
import EPFParameters from "../../views/pages/Employees/EPFParameters.jsx";
import ESICParameters from "../../views/pages/Employees/ESICParameters.jsx";
import BonusParameters from "../../views/pages/Employees/BonusParameters.jsx";
import GenearalParameters from "../../views/pages/Employees/GeneralParameters.jsx";
import GratuityParameters from "../../views/pages/Employees/GratuityParameters.jsx";
import LeaveParameters from "../../views/pages/Employees/LeaveParameters.jsx";
import ComboOffParameters from "../../views/pages/Employees/ComboOffParameters.jsx";
import OverParameters from "../../views/pages/Employees/OverParameters.jsx";
import ArrearParameters from "../../views/pages/Employees/ArrearParameters.jsx";
import TdsParameters from "../../views/pages/Employees/TdsParameters.jsx";
import AdvancePaymentParameters from "../../views/pages/Employees/AdvancePaymentParameters.jsx";
import ProfessionalTaxParameters from "../../views/pages/Employees/ProfessionalTaxParameters.jsx";
import Allowences from "../../views/pages/Employees/Allowences.jsx";
import Deduction from "../../views/pages/Employees/Deduction.jsx";
import NationalHoliday from "../../views/pages/Employees/NationalHoliday.jsx";
...
const AppContainer = () => {
  ...
  const routingObjects = [
    ...
    {
      id: 48,
      path: userrole === "admin" ? "clients-list" : "employees-list",
      element: userrole === "admin" ? <ClientList /> : <EmployeeList />,
    },
    {
      id: 49,
      path: "task-board",
    ...
    },
    {
      id: 122,
      path: "epfparametres",
      element: <EPFParameters />,
    },
    {
      id: 123,
      path: "esicparametres",
      element: <ESICParameters />,
    },
    {
      id: 124,
      path: "bonusparametres",
      element: <BonusParameters />,
    },
    {
      id: 125,
      path: "generalparametres",
      element: <GenearalParameters />,
    },
    {
      id: 126,
      path: "gratuityparametres",
      element: <GratuityParameters />,
    },
    {
      id: 127,
      path: "leaveparametres",
      element: <LeaveParameters />,
    },
    {
      id: 128,
      path: "combooffparametres",
      element: <ComboOffParameters />,
    },
    {
      id: 129,
      path: "overparametres",
      element: <OverParameters />,
    },
    {
      id: 130,
      path: "arrearparametres",
      element: <ArrearParameters />,
    },
    {
      id: 131,
      path: "tdsparametres",
      element: <TdsParameters />,
    },
    {
      id: 132,
      path: "advancepaymentparametres",
      element: <AdvancePaymentParameters />,
    },
    {
      id: 133,
      path: "professionaltaxparametres",
      element: <ProfessionalTaxParameters />,
    },
    {
      id: 134,
      path: "allowances",
    ...
    {
      id: 137,
      path: "daily-attend-employee",
      element: <DailyBasisAttendence />,
    },
    {
      id: 138,
      ...
      {localStorage.length > 0 ? (
        <div className="main-wrapper" onClick={mobileResponsive}>
          <Routes>
            ...
            {/* <Route path={"/call/*"} element={<ChatSidebarLayout />}>
              {ChatRoutingeObjects.map((item) => (
                <Route key={item.id} path={item.path} element={item.element} />
              ))}
            </Route> */}
            {/* <Route path={"/ui/*"} element={<ComponentSidebarLayout />}>
              {ComponentsRoutingeObjects.map((item) => (
                <Route key={item.id} path={item.path} element={item.element} />
              ))}
            </Route> */}
            {/* <Route path={"/email/*"} element={<EmailSidebarLayout />}>
              {EmailRoutingeObjects.map((item) => (
                <Route key={item.id} path={item.path} element={item.element} />
              ))}
            </Route> */}
            {/* <Route path={"/settings/*"} element={<SettingsSidebarLayout />}>
              {SettingsRoutingeObjects.map((item) => (
                <Route key={item.id} path={item.path} element={item.element} />
              ))}
            </Route> */}
            {/* <Route path={"/task/*"} element={<ProjectSidebarLayout />}>
